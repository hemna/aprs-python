...
class ParseRawGPS(unittest.TestCase):
    ...
    def test_ultimeter_format(self):
        """Test ULTW (Ultimeter weather) format"""
        ...
        self.assertEqual(result['format_id'], 'ULTW')
        self.assertTrue(result['ultimeter_format'])
        self.assertIn('hex_data', result)
        self.assertIn('ultimeter_data', result)
    ...
    def test_ultimeter_format_short_data(self):
        ...
        self.assertEqual(result['format_id'], 'ULTW')
        self.assertTrue(result['ultimeter_format'])
        self.assertEqual(result['hex_data'], '00A100EB')
    ...
    def test_nmea_rmc_south_west(self):
        ...
        packet = "TEST>APRS:$GPRMC,123519,A,4807.038,S,01131.000,W,022.4,084.4,230394,003.1,W*6A"
        result = parse(packet)
    ...
    def test_nmea_rmc_invalid_status(self):
        ...
        packet = "TEST>APRS:$GPRMC,123519,V,4807.038,N,01131.000,E,022.4,084.4,230394,003.1,W*6A"
        result = parse(packet)
    ...
    def test_nmea_gga_south_west(self):
        ...
        packet = "TEST>APRS:$GPGGA,123519,4807.038,S,01131.000,W,1,08,0.9,545.4,M,46.9,M,,*47"
        result = parse(packet)
    ...
    def test_nmea_gga_no_fix(self):
        ...
        packet = "TEST>APRS:$GPGGA,123519,4807.038,N,01131.000,E,0,00,0.9,,M,,M,,*47"
        result = parse(packet)
    ...
    def test_nmea_other_sentence_types(self):
        ...
        packet = "TEST>APRS:$GPGLL,4807.038,N,01131.000,E,123519,A*1D"
        result = parse(packet)
    ...
    def test_nmea_different_talker(self):
        ...
        packet = "TEST>APRS:$GLRMC,123519,A,4807.038,N,01131.000,E,022.4,084.4,230394,003.1,W*6A"
        result = parse(packet)
    ...
    def test_nmea_rmc_coordinate_parsing(self):
        ...
        packet = "TEST>APRS:$GPRMC,123519,A,4903.50,N,07201.75,W,022.4,084.4,230394,003.1,W*6A"
        result = parse(packet)
    ...
    def test_nmea_gga_coordinate_parsing(self):
        ...
        packet = "TEST>APRS:$GPGGA,123519,4903.50,N,07201.75,W,1,08,0.9,545.4,M,46.9,M,,*47"
        result = parse(packet)
    ...
    def test_nmea_rmc_speed_conversion(self):
        ...
        packet = "TEST>APRS:$GPRMC,123519,A,4807.038,N,01131.000,E,10.0,084.4,230394,003.1,W*6A"
        result = parse(packet)
